...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        GiphyCore.configure(apiKey: "2Npw03wgI1DEdrGVsTgXUAxW0YhITfWz")
        customizeAppearance()
        return true
    }
    ...
    private func customizeAppearance() {
        window?.tintColor = UIColor.blackRussian
        UISearchBar.appearance().barTintColor = UIColor.blackRussian
        UINavigationBar.appearance().barTintColor = UIColor.blackRussian
